...
import SentryTestPage from "./pages/dev/SentryTestPage"; // TEMPORARY — Task 3E P-24 re-verify, delete after check
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/dev/sentry-test-temp" component={SentryTestPage} /> {/* TEMPORARY — Task 3E P-24 re-verify, delete after check */}
