...
| TC-LAUNCH-003-05 | Manual | P0 | Full flow on localhost: request reset → console-logged email link → open → set new password → login works with new password, old fails | 🔲 | |
