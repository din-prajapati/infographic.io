...
> **Status:** ✅ Done — all 6 ACs verified. AC5 failed live 2026-08-14 (found BL-08, a box-width bug outside this story's own scope), fixed and re-verified live 2026-08-15.
...
| TC-AI-049-04 | Auto (E2E, live) | P1 | Live: price renders one line; fonts visually match preview (AC3/5) | ✅ Pass | `e2e/us-ai-049-font-mapping.spec.ts` — failed 2026-08-14 (found BL-08), fixed + re-verified 2026-08-15, `lineCount: 1` |
...
- [x] All ACs checked ✅ · test cases recorded · Gate 1 green (tsc clean, backend 350/350, client 216/216)
