...
- [x] **AC9 [regression]** *(added during implementation — a regression the original ACs would
      have shipped):* `client/src/components/ai-chat/AIChatBox.tsx` publishes its completed
