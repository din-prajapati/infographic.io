...
> **Capability:** Arch-B06
> **Linear:** LIN-US-AI-020 | **Created:** 2026-04-28
...
*I want* Cloudflare R2 asset storage and signed URLs
...
- [ ] **AC1:** Core capability (Arch-B06) implemented and working end-to-end
...
- Capabilities outside Arch-B06 scope
...
- **Branch:** `feat/ai-us-ai-020-r2-storage`
...
Capability: Arch-B06 — Cloudflare R2 asset storage and signed URLs
...
|-------|------|----------|----------|--------|
| TC-US-AI-020-01 | Manual | P0 | Core Arch-B06 capability works end-to-end | 🔲 |
| TC-US-AI-020-02 | Manual | P1 | No model/technical details visible in UI | 🔲 |
