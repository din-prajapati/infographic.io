...
> **Capability:** CAP-14
> **Linear:** LIN-US-AI-018 | **Created:** 2026-04-28
...
*I want* Edit listing details in image — text-in-image
...
- [ ] **AC1:** Core capability (CAP-14) implemented and working end-to-end
...
- Capabilities outside CAP-14 scope
...
- **Branch:** `feat/ai-us-ai-018-text-in-image`
...
Capability: CAP-14 — Edit listing details in image — text-in-image
...
|-------|------|----------|----------|--------|
| TC-US-AI-018-01 | Manual | P0 | Core CAP-14 capability works end-to-end | 🔲 |
| TC-US-AI-018-02 | Manual | P1 | No model/technical details visible in UI | 🔲 |
