...
| [EPIC-AI-06](epics/phase-1-ai-core/EPIC-AI-06/EPIC.md) | Hybrid Real-Photo Pipeline (real photo background · editable overlay · synthetic guard) — **promoted to Phase 1** | [phase-1-ai-core](epics/phase-1-ai-core/) | 🟡 In Progress — editable canvas proven live 2026-08-13, see EPIC.md log | ~30h+ | US-AI-031 to US-AI-051 (status row stale beyond that — see EPIC.md for current detail) |
...
| [EPIC-LAUNCH-01](epics/phase-1-ai-core/EPIC-LAUNCH-01/EPIC.md) | Go-Live & Revenue Readiness (RazorPay live · email + password reset · legal pages · beta mode · metering) — **Phase 1 priority #1, added 2026-07-07** | [phase-1-ai-core](epics/phase-1-ai-core/) | 🟡 In Progress — 8/14 stories ✅ Done (004, 006, 007, 008, 010, 011, 012, 013); 4 more implemented+merged pending Task 3 sign-off (001, 002, 003, 009); US-LAUNCH-005 open (real ₹ txn); US-LAUNCH-014 backlog; US-LAUNCH-015 added 2026-08-13 (editable-design monetization) | ~20h + ops | US-LAUNCH-001 to US-LAUNCH-015 |
| [EPIC-DEPLOY-01](epics/phase-1-ai-core/EPIC-DEPLOY-01/EPIC.md) | Deployment Velocity & Safety (Cursor-style: CI gate · preview envs · feature flags · migrations · progressive delivery) — **non-blocking to beta, added 2026-07-13** | [phase-1-ai-core](epics/phase-1-ai-core/) | 🔲 Not Started | ~5 days | US-DEPLOY-001 to US-DEPLOY-006 |
