...
> **See also:** [PHASE_TRACKER.md](PHASE_TRACKER.md) (executive view) · [ESTIMATES.md](ESTIMATES.md) (remaining effort by phase, with derivation) · [AGILE_INDEX.md](AGILE_INDEX.md) (epic registry) · [LAUNCH_TIMELINE.md](LAUNCH_TIMELINE.md) (dated timeline: marketable beta in 1–2 days · deploy maturity ~2 wks parallel · revenue ~3–4 wks)
...
| **3** | ✅ **[EPIC-AI-06](epics/phase-1-ai-core/EPIC-AI-06/EPIC.md)** — Hybrid Real-Photo Pipeline — **fully closed 2026-08-15, both milestones.** M-AI-18 (editable overlay, 10 stories) and M-AI-17 (real-photo composition, US-AI-031/031b — credit topped up same day, both live-verified) | **The chargeability gate.** Agents must market their actual listing photo, not an AI-invented house with a fake headshot. This is what makes the product defensibly paid. | ~30 h | Revenue |
| **3∥** | 🟡 **[M-LAUNCH-02-revenue-on](epics/phase-1-ai-core/EPIC-LAUNCH-01/milestones/M-LAUNCH-02-revenue-on.md) prep** — 6/7 stories Done (005 RazorPay AC1-4 done · 006 receipt email · 007 BROKERAGE gate · 008 metering guard · 012/013 dunning+renewal email · **015 editable-design monetization, closed 2026-08-15**) — **only US-LAUNCH-005 AC5/6 (real ₹ txn) open** | Mostly ops + small PRs; runs parallel to rank 3. RazorPay activation review needs rank 1's legal pages live. | ~8–10 h + review latency | Revenue |
| **3∥∥** | 🔲 **[EPIC-INFRA-02](epics/phase-1-ai-core/EPIC-INFRA-02/EPIC.md)** — Durable Asset Storage (Cloudflare R2), added 2026-08-19, not started | Generated images/composed designs currently live only on Ideogram's expiring URLs — a paying customer's deliverable can silently disappear. Must ship before the real ₹ transaction. | ~1 day | Revenue |
| **3∥∥∥** | 🔲 **[EPIC-PAY-05](epics/phase-1-ai-core/EPIC-PAY-05/EPIC.md)** — Pricing Relaunch (Founding Customer launch), added 2026-08-21, not started | The real ₹ transaction (US-LAUNCH-005 AC6) should run against the relaunched, feasibility-checked prices — not the old beta prices, which measured 8% worst-case margin with editable usage. | ~4–6 days | Revenue |
| — | 💰 **REVENUE ON — gated on 4 items, not 1** (corrected 2026-08-21 — this line previously said "one story away," stale since 2026-08-19). `BETA_MODE=false` needs rank 3, 3∥, 3∥∥, and 3∥∥∥ all closed: rank 3 is closed; 3∥ needs only US-LAUNCH-005's real ₹ transaction (checkout → webhook → ACTIVE → receipt → refund test); 3∥∥ (durable storage) and 3∥∥∥ (pricing relaunch) are both not started | | | |
