...
| — | [EPIC-MKT-01](epics/phase-1-ai-core/EPIC-MKT-01/EPIC.md) | MKT | Market-Aware Generation — MarketProfile, market-aware extraction, three-axis offshore authoring, persona. Drafted 2026-09-08 from BL-22 steps 2–5; **unscheduled on purpose** — trigger is beta showing a market whose output is wrong, not a date | 🔲 0/6, not started |
