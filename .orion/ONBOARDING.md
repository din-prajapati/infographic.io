---
title: InfographicAI — ORION Onboarding
type: onboarding
tags: [orion, onboarding]
updated: 2026-07-08
---

# Onboarding — InfographicAI
...
3. **Skim your stack's rules** (10 min) — only the layers/techs this project uses:
   - `.orion/rules/frontend/RULES.md` (layer-wide)
   - `.orion/rules/frontend/react/RULES.md` (react)
   - `.orion/rules/frontend/tailwind/RULES.md` (tailwind)
   - `.orion/rules/backend/RULES.md` (layer-wide)
   - `.orion/rules/backend/nestjs/RULES.md` (nestjs)
   - `.orion/rules/database/RULES.md` (layer-wide)
   - `.orion/rules/database/prisma/RULES.md` (prisma)
   - `.orion/rules/testing/RULES.md` (layer-wide)
   - `.orion/rules/testing/vitest/RULES.md` (vitest)
   - `.orion/rules/testing/playwright/RULES.md` (playwright)
   - `.orion/rules/platform/RULES.md` (layer-wide)
   - `.orion/rules/platform/railway/RULES.md` (railway)
   - `.orion/rules/integrations/RULES.md` (layer-wide)
   - `.orion/rules/integrations/sentry/RULES.md` (sentry)
...
Domains in this project: DESIGN, PAY, AUTH, EDIT, AI, USAGE, INFRA, ORG, API, TEST, MOBILE, KIT, GEN, LAUNCH
